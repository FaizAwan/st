            ...
            <div className="col-lg-6">
              <div className="breadcrumb-content">
                <div className="section-heading">
                  <h2 className="sec__title font-size-30 text-white">Expenses</h2>
                </div>
            ...
            <div className="col-lg-12">
              <div className="form-box">
                <div className="form-title-wrap">
                  <div className="d-flex align-items-center justify-content-between">
                    <div>
                      <h3 className="title">Expense Lists</h3>
                      <p className="font-size-14">Showing 1 to 8 of 20 results</p>
                    </div>
                    <div className="select-contain">
                      <Link href="addExpense" className="btn btn-primary"> Add Expense </Link>
                    </div>
                  </div>
                </div>
                          ...
                          <tr key={Expense.id}>
                            <td>
                              <div className="table-content">
                                <h3 className="title">{Expense.name}</h3>
                              </div>
                            </td>
                            <td>
                              <div className="table-content">
                                <h3 className="title">{Expense.urdu_name}</h3>
                              </div>
                            </td>
