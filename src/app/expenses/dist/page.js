...
var Expenses = function () {
    ...
    var _b = react_1.useState([]), Expenses = _b[0], setExpenses = _b[1];
    ...
    react_1.useEffect(function () {
        ...
        var ExpensesRef = database_1.ref(db, 'Expenses/');
        database_1.onValue(ExpensesRef, function (snapshot) {
            var data = snapshot.val();
            var ExpensesList = Object.keys(data).map(function (key) { return (__assign({ id: key }, data[key])); });
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "Expenses")))),
                            React.createElement("div", { className: "col-lg-6" },
                                    ...
                                    React.createElement("div", { className: "form-title-wrap" },
                                        React.createElement("div", { className: "d-flex align-items-center justify-content-between" },
                                            React.createElement("div", null,
                                                React.createElement("h3", { className: "title" }, "Expense Lists"),
                                            ...
                                            React.createElement("div", { className: "select-contain" },
                                                React.createElement(link_1["default"], { href: "addExpense", className: "btn btn-primary" }, " Add Expense ")))),
                                            ...
                                            React.createElement("table", { className: "table" },
                                                React.createElement("thead", null,
                                                    React.createElement("tr", null,
                                                        React.createElement("th", { scope: "col" }, "Expense Name"),
                                                        React.createElement("th", { scope: "col" }, "Urdu Name"),
                                                        React.createElement("th", { scope: "col" }, "Status"),
                                                        React.createElement("th", { scope: "col" }, "Action"))),
                                                React.createElement("tbody", null, Expenses.map(function (Expense) { return (React.createElement("tr", { key: Expense.id },
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, Expense.name))),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, Expense.urdu_name))),
                                                    React.createElement("td", null, Expense.status),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
