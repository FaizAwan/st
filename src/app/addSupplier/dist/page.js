...
var AddSupplier = function () {
    ...
    var submitForm = function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var db, supplierIdRef, accountIdRef, supplierSnapshot, nextsupplierId, accountSnapshot, nextAccountId, supplierData, suppliersRef, accountsData, accountsRef, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(name && city && whatsapp && address && urdu_name && status)) return [3 /*break*/, 9];
                        db = database_1.getDatabase();
                        supplierIdRef = database_1.ref(db, 'supplier_id_counter');
                        accountIdRef = database_1.ref(db, 'account_id_counter');
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 8, , 9]);
                        return [4 /*yield*/, database_1.get(supplierIdRef)];
                    case 2:
                        supplierSnapshot = _b.sent();
                        nextsupplierId = (supplierSnapshot.val() || 0) + 1;
                    ...
                    case 3:
                        ...
                        suppliersRef = database_1.ref(db, 'suppliers/' + nextsupplierId);
                        return [4 /*yield*/, database_1.set(suppliersRef, supplierData)];
                    case 4:
                        _b.sent();
                        accountsData = {
                    ...
                    case 5:
                        _b.sent();
                        // Update the supplier ID counter
                        return [4 /*yield*/, database_1.set(supplierIdRef, nextsupplierId)];
                    case 6:
                        // Update the supplier ID counter
                        _b.sent();
                    ...
                    case 7:
                        ...
                        setVisibility("");
                        router.push('/suppliers'); // Redirect to the suppliers page
                        return [3 /*break*/, 9];
                    case 8:
                        e_1 = _b.sent();
                        alert("Failed to save supplier information " + e_1.message);
                        return [3 /*break*/, 9];
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "Add Supplier")))),
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-list text-right" },
                                    React.createElement("ul", { className: "list-items" },
                                        ...
                                        React.createElement("li", null, "Suppliers"))))))),
                                ...
                                React.createElement("div", { className: "row" },
                                    React.createElement("div", { className: "col-lg-9 mx-auto" },
                                        React.createElement("div", { className: "listing-header pb-4" },
                                            React.createElement("h3", { className: "title font-size-28 pb-2" }, "Add Supplier Form")),
