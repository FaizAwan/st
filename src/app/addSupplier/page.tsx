...
const AddSupplier = () => {
  ...
  const submitForm = async ({ name, city, whatsapp, urdu_name, address, status }: {
    ...
    if (name && city && whatsapp && address && urdu_name && status) {
      ...
      const supplierIdRef = ref(db, 'supplier_id_counter');
      const accountIdRef = ref(db, 'account_id_counter');
      try {
        // Get the next supplier ID
        const supplierSnapshot = await get(supplierIdRef);
        const nextsupplierId = (supplierSnapshot.val() || 0) + 1; // Increment supplier ID
        ...
        // Write to the suppliers table
        const suppliersRef = ref(db, 'suppliers/' + nextsupplierId);
        await set(suppliersRef, supplierData);
        
        // Write to the accounts table (only account_id, supplier_id, type)
        const accountsData = {
        ...
        await set(supplierIdRef, nextsupplierId);
        ...
        alert("Failed to save supplier information " + e.message);
      }
    }
  };
            ...
            <div className="col-lg-6">
              <div className="breadcrumb-content">
                <div className="section-heading">
                  <h2 className="sec__title font-size-30 text-white">Add Supplier</h2>
                </div>
      ...
      <div className="row">
        <div className="col-lg-9 mx-auto">
          <div className="listing-header pb-4">
            <h3 className="title font-size-28 pb-2">Add Supplier Form</h3>
          </div>
          <div className="form-box">
            <div className="form-title-wrap">
              <h3 className="title"><i className="la la-user mr-2 text-gray" />Supplier information</h3>
            </div>{/* form-title-wrap */}
