...
const Banks = () => {
    ...
    useEffect(() => {
      ...
      onValue(BanksRef, (snapshot) => {
        ...
        const BanksList = Object.keys(data).map(key => ({
          id: key,
          ...data[key]
        }));
        setBanks(BanksList);
            ...
            <div className="col-lg-6">
              <div className="breadcrumb-content">
                <div className="section-heading">
                  <h2 className="sec__title font-size-30 text-white">Banks</h2>
                </div>
            ...
            <div className="col-lg-12">
              <div className="form-box">
                <div className="form-title-wrap">
                  <div className="d-flex align-items-center justify-content-between">
                    <div>
                      <h3 className="title">Bank Lists</h3>
                      <p className="font-size-14">Showing 1 to 8 of 20 results</p>
                    </div>
                    <div className="select-contain">
                      <Link href="addBank" className="btn btn-primary"> Add Bank </Link>
                    </div>
                  </div>
                </div>
                    ...
                    <table className="table">
                      ...
                      {Banks.map(Bank => (
                          <tr key={Bank.id}>
                            ...
                            <td>
                              <div className="table-content">
                                <h3 className="title">{Bank.urdu_name}</h3>
                              </div>
                            </td>
                            <td>{Bank.whatsapp}</td>
                            <td>{Bank.city}</td>
