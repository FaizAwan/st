...
var Banks = function () {
    ...
    var _b = react_1.useState([]), Banks = _b[0], setBanks = _b[1];
    ...
    react_1.useEffect(function () {
        ...
        var BanksRef = database_1.ref(db, 'Banks/');
        database_1.onValue(BanksRef, function (snapshot) {
            var data = snapshot.val();
            var BanksList = Object.keys(data).map(function (key) { return (__assign({ id: key }, data[key])); });
            setBanks(BanksList);
        });
    }, []);
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "Banks")))),
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-list text-right" },
                                    React.createElement("ul", { className: "list-items" },
                                        React.createElement("li", null,
                                            React.createElement(link_1["default"], { href: "customers", className: "text-white" }, "Customers")),
                                        React.createElement("li", null,
                                    ...
                                    React.createElement("div", { className: "form-title-wrap" },
                                        React.createElement("div", { className: "d-flex align-items-center justify-content-between" },
                                            React.createElement("div", null,
                                                React.createElement("h3", { className: "title" }, "Bank Lists"),
                                            ...
                                            React.createElement("div", { className: "select-contain" },
                                                React.createElement(link_1["default"], { href: "addBank", className: "btn btn-primary" }, " Add Bank ")))),
                                            ...
                                            React.createElement("table", { className: "table" },
                                                React.createElement("thead", null,
                                                    React.createElement("tr", null,
                                                        React.createElement("th", { scope: "col" }, "Bank Name"),
                                                ...
                                                React.createElement("tbody", null, Banks.map(function (Bank) { return (React.createElement("tr", { key: Bank.id },
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, Bank.name))),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, Bank.urdu_name))),
                                                    React.createElement("td", null, Bank.whatsapp),
                                                    React.createElement("td", null, Bank.city),
                                                    React.createElement("td", null, Bank.address),
                                                    React.createElement("td", null),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
