            ...
            <div className="col-lg-6">
              <div className="breadcrumb-content">
                <div className="section-heading">
                  <h2 className="sec__title font-size-30 text-white">Products</h2>
                </div>
            ...
            <div className="col-lg-12">
              <div className="form-box">
                <div className="form-title-wrap">
                  <div className="d-flex align-items-center justify-content-between">
                    <div>
                      <h3 className="title">Product Lists</h3>
                      <p className="font-size-14">Showing 1 to 8 of 20 results</p>
                    </div>
                    <div className="select-contain">
                      <Link href="addProduct" className="btn btn-primary"> Add Product </Link>
                    </div>
                  </div>
                </div>
                    ...
                    <table className="table">
                      ...
                      {Products.map(Product => (
                          <tr key={Product.id}>
                            ...
                            <td>
                              <div className="table-content">
                                <h3 className="title">{Product.urdu_name}</h3>
                              </div>
                            </td>
                            <td>{Product.main_category}</td>
                            <td>{Product.category}</td>
                            <td>{Product.packing} KG</td>
