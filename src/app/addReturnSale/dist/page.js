...
var AddReturnSale = function () {
    ...
    var submitForm = function (_a) {
        var ReturnSales_date = _a.ReturnSales_date, ReturnSales_id = _a.ReturnSales_id, customer_name = _a.customer_name, note = _a.note, total_amount = _a.total_amount;
        return __awaiter(void 0, void 0, void 0, function () {
            var db_1, ReturnSalesIdRef, ReturnSalesnapshot, nextReturnSalesId_1, ReturnSalesData, ReturnSalesRef, ReturnSalesProductRef, productPromises, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        console.log("Form data received:", {
                            ReturnSales_date: ReturnSales_date,
                            ReturnSales_id: ReturnSales_id,
                            customer_name: customer_name,
                            note: note,
                            total_amount: total_amount
                        });
                        if (!(ReturnSales_date && ReturnSales_id && customer_name && note && total_amount)) return [3 /*break*/, 8];
                        db_1 = database_1.getDatabase();
                        ReturnSalesIdRef = database_1.ref(db_1, 'ReturnSales_id_counter');
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 6, , 7]);
                        console.log("Fetching the next ReturnSales ID...");
                        return [4 /*yield*/, database_1.get(ReturnSalesIdRef)];
                    case 2:
                        ReturnSalesnapshot = _b.sent();
                        nextReturnSalesId_1 = (ReturnSalesnapshot.val() || 0) + 1;
                        console.log("Next ReturnSales ID:", nextReturnSalesId_1);
                        ReturnSalesData = {
                            ReturnSales_id: nextReturnSalesId_1,
                            ReturnSales_date: ReturnSales_date,
                            customer_name: customer_name,
                            note: note,
                        ...
                        ReturnSalesRef = database_1.ref(db_1, 'ReturnSales/' + nextReturnSalesId_1);
                        return [4 /*yield*/, database_1.set(ReturnSalesRef, ReturnSalesData)];
                    case 3:
                        _b.sent();
                        // console.log("ReturnSales data saved successfully.");
                        // Update the ReturnSales ID counter
                        return [4 /*yield*/, database_1.set(ReturnSalesIdRef, nextReturnSalesId_1)];
                    case 4:
                        // console.log("ReturnSales data saved successfully.");
                        // Update the ReturnSales ID counter
                        _b.sent();
                        ReturnSalesProductRef = database_1.ref(db_1, 'ReturnSalesProduct');
                        productPromises = productTableData.map(function (product, index) {
                            ...
                            var productKey = nextReturnSalesId_1 + "_" + (index + 1);
                            return database_1.set(database_1.ref(db_1, "ReturnSalesProduct/" + productKey), productEntry);
                        });
                    ...
                    case 6:
                        e_1 = _b.sent();
                        console.error("Error saving ReturnSales information:", e_1);
                        alert("Failed to save ReturnSales information " + e_1.message);
                        return [3 /*break*/, 7];
                            ...
                            react_1["default"].createElement("div", { className: "col-lg-6" },
                                react_1["default"].createElement("div", { className: "breadcrumb-content" },
                                    react_1["default"].createElement("div", { className: "section-heading" },
                                        react_1["default"].createElement("h2", { className: "sec__title font-size-30 text-white" }, "Add Return Sale")))),
                            react_1["default"].createElement("div", { className: "col-lg-6" },
                                react_1["default"].createElement("div", { className: "breadcrumb-list text-right" },
                                    react_1["default"].createElement("ul", { className: "list-items" },
                                        ...
                                        react_1["default"].createElement("li", null, "Return ReturnSales"))))))),
                                                        ...
                                                        react_1["default"].createElement("div", { className: "col-lg-1" },
                                                            react_1["default"].createElement("div", { className: "input-box" },
                                                                ...
                                                                react_1["default"].createElement("div", { className: "form-group" },
                                                                    ...
                                                                    react_1["default"].createElement("input", __assign({ className: "form-control", value: "981", type: "text" }, register("ReturnSales_id")))),
                                                                errors.ReturnSales_id && react_1["default"].createElement("p", { className: "text-danger" }, errors.ReturnSales_id.message))),
                                                        ...
                                                        react_1["default"].createElement("div", { className: "col-lg-2" },
                                                            react_1["default"].createElement("div", { className: "input-box" },
                                                                ...
                                                                react_1["default"].createElement("div", { className: "form-group" },
                                                                    ...
                                                                    react_1["default"].createElement("input", __assign({ className: "form-control", type: "date" }, register("ReturnSales_date")))),
                                                                errors.ReturnSales_date && react_1["default"].createElement("p", { className: "text-danger" }, errors.ReturnSales_date.message))),
