...
var AddProduct = function () {
    ...
    var _b = profilePasswordValidation(), passwordHandleSubmit = _b.handleSubmit, registerPassword = _b.register, passwordErrors = _b.formState.errors;
    ...
    var submitForm = function (_a) {
        var name = _a.name, category = _a.category, main_category = _a.main_category, packing = _a.packing, urdu_name = _a.urdu_name, status = _a.status;
        return __awaiter(void 0, void 0, void 0, function () {
            var db, ProductIdRef, ProductSnapshot, nextProductId, ProductData, ProductsRef, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(name && category && urdu_name && status && packing && main_category)) return [3 /*break*/, 6];
                        db = database_1.getDatabase();
                        ProductIdRef = database_1.ref(db, 'Product_id_counter');
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, database_1.get(ProductIdRef)];
                    case 2:
                        ProductSnapshot = _b.sent();
                        nextProductId = (ProductSnapshot.val() || 0) + 1;
                        ProductData = {
                        ...
                        ProductsRef = database_1.ref(db, 'Products/' + nextProductId);
                        return [4 /*yield*/, database_1.set(ProductsRef, ProductData)];
                    case 3:
                        _b.sent();
                        // Write to the accounts table (only account_id, Product_id, type)
                        // Update the Product ID counter
                        return [4 /*yield*/, database_1.set(ProductIdRef, nextProductId)];
                    case 4:
                        // Write to the accounts table (only account_id, Product_id, type)
                        // Update the Product ID counter
                        _b.sent();
                    ...
                    case 5:
                        e_1 = _b.sent();
                        alert("Failed to save Product information " + e_1.message);
                        return [3 /*break*/, 6];
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "Add Product")))),
                            React.createElement("div", { className: "col-lg-6" },
                                ...
                                React.createElement("div", { className: "row" },
                                    React.createElement("div", { className: "col-lg-9 mx-auto" },
                                        React.createElement("div", { className: "listing-header pb-4" },
                                            React.createElement("h3", { className: "title font-size-28 pb-2" }, "Add Product Form")),
                                            ...
                                            React.createElement("div", { className: "form-content contact-form-action" },
                                                React.createElement("form", { onSubmit: handleSubmit(submitForm) },
                                                    React.createElement("div", { className: "row" },
                                                        ...
                                                        React.createElement("div", { className: "col-lg-6" },
                                                            React.createElement("div", { className: "input-box" },
                                                                React.createElement("label", { className: "label-text" }, "Main Category"),
                                                                React.createElement("div", { className: "form-group" },
                                                                    React.createElement("span", { className: "la la-envelope form-icon" }),
                                                                    React.createElement("input", __assign({ className: "form-control", type: "text" }, register("main_category")))),
                                                                errors.main_category && React.createElement("p", { className: "text-danger" }, errors.main_category.message))),
                                                        React.createElement("div", { className: "col-lg-6" },
                                                            React.createElement("div", { className: "input-box" },
                                                                React.createElement("label", { className: "label-text" }, "Category"),
                                                                React.createElement("div", { className: "form-group" },
                                                                    React.createElement("span", { className: "la la-envelope form-icon" }),
                                                                    React.createElement("input", __assign({ className: "form-control", type: "text" }, register("category")))),
                                                                errors.category && React.createElement("p", { className: "text-danger" }, errors.category.message))),
                                                        React.createElement("div", { className: "col-lg-6" },
                                                            React.createElement("div", { className: "input-box" },
                                                                React.createElement("label", { className: "label-text" }, "Packing"),
                                                                React.createElement("div", { className: "form-group" },
                                                                    React.createElement("span", { className: "la la-envelope form-icon" }),
                                                                    React.createElement("input", __assign({ className: "form-control", type: "text" }, register("packing")))),
                                                                errors.packing && React.createElement("p", { className: "text-danger" }, errors.packing.message))),
                                                        React.createElement("div", { className: "col-lg-6" },
                                                            React.createElement("div", { className: "input-box" },
                                                        ...
                                                        React.createElement("div", { className: "col-lg-12" },
                                                            React.createElement("div", { className: "btn-box" },
                                                                React.createElement(Button_1["default"], { type: "submit", className: "btn btn-primary", label: "Add Product" }))))))))))),
