...
var Suppliers = function () {
    ...
    react_1.useEffect(function () {
        ...
        var customersRef = database_1.ref(db, 'suppliers/');
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "Suppliers")))),
                            React.createElement("div", { className: "col-lg-6" },
                                    ...
                                    React.createElement("div", { className: "form-title-wrap" },
                                        React.createElement("div", { className: "d-flex align-items-center justify-content-between" },
                                            React.createElement("div", null,
                                                React.createElement("h3", { className: "title" }, "Suppliers Lists"),
                                            ...
                                            React.createElement("div", { className: "select-contain" },
                                                React.createElement(link_1["default"], { href: "addSupplier", className: "btn btn-primary" }, " Add Supplier ")))),
                                            ...
                                            React.createElement("table", { className: "table" },
                                                React.createElement("thead", null,
                                                    React.createElement("tr", null,
                                                        React.createElement("th", { scope: "col" }, "Supplier Name"),
                                                ...
                                                React.createElement("tbody", null, customers.map(function (customer) { return (React.createElement("tr", { key: customer.id },
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, customer.name))),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, customer.urdu_name))),
                                                    React.createElement("td", null, customer.whatsapp),
                                                    React.createElement("td", null, customer.city),
                                                    React.createElement("td", null, customer.address),
                                                    React.createElement("td", null, customer.status),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
