...
var AddPurchase = function () {
    ...
    var submitForm = function (_a) {
        var purchase_date = _a.purchase_date, purchase_id = _a.purchase_id, customer_name = _a.customer_name, note = _a.note, total_amount = _a.total_amount;
        return __awaiter(void 0, void 0, void 0, function () {
            var db_1, purchaseIdRef, purchasenapshot, nextpurchaseId_1, purchaseData, purchaseRef, purchaseProductRef, productPromises, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(purchase_date && purchase_id && customer_name && note && total_amount)) return [3 /*break*/, 8];
                        db_1 = database_1.getDatabase();
                        purchaseIdRef = database_1.ref(db_1, 'purchase_id_counter');
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 6, , 7]);
                        console.log("Fetching the next purchase ID...");
                        return [4 /*yield*/, database_1.get(purchaseIdRef)];
                    case 2:
                        purchasenapshot = _b.sent();
                        nextpurchaseId_1 = (purchasenapshot.val() || 0) + 1;
                        console.log("Next purchase ID:", nextpurchaseId_1);
                        purchaseData = {
                            purchase_id: nextpurchaseId_1,
                            purchase_date: purchase_date,
                            customer_name: customer_name,
                            note: note,
                        ...
                        purchaseRef = database_1.ref(db_1, 'purchase/' + nextpurchaseId_1);
                        return [4 /*yield*/, database_1.set(purchaseRef, purchaseData)];
                    case 3:
                        _b.sent();
                        // console.log("purchase data saved successfully.");
                        // Update the purchase ID counter
                        return [4 /*yield*/, database_1.set(purchaseIdRef, nextpurchaseId_1)];
                    case 4:
                        // console.log("purchase data saved successfully.");
                        // Update the purchase ID counter
                        _b.sent();
                        purchaseProductRef = database_1.ref(db_1, 'purchaseProduct');
                        productPromises = productTableData.map(function (product, index) {
                            ...
                            var productKey = nextpurchaseId_1 + "_" + (index + 1);
                            return database_1.set(database_1.ref(db_1, "purchaseProduct/" + productKey), productEntry);
                        });
                    ...
                    case 6:
                        e_1 = _b.sent();
                        console.error("Error saving purchase information:", e_1);
                        alert("Failed to save purchase information " + e_1.message);
                        return [3 /*break*/, 7];
                            ...
                            react_1["default"].createElement("div", { className: "col-lg-6" },
                                react_1["default"].createElement("div", { className: "breadcrumb-content" },
                                    react_1["default"].createElement("div", { className: "section-heading" },
                                        react_1["default"].createElement("h2", { className: "sec__title font-size-30 text-white" }, "add Purchase")))),
                            react_1["default"].createElement("div", { className: "col-lg-6" },
                                react_1["default"].createElement("div", { className: "breadcrumb-list text-right" },
                                    react_1["default"].createElement("ul", { className: "list-items" },
                                        ...
                                        react_1["default"].createElement("li", null, "purchase"))))))),
                                                        ...
                                                        react_1["default"].createElement("div", { className: "col-lg-1" },
                                                            react_1["default"].createElement("div", { className: "input-box" },
                                                                ...
                                                                react_1["default"].createElement("div", { className: "form-group" },
                                                                    ...
                                                                    react_1["default"].createElement("input", __assign({ className: "form-control", value: "981", type: "text" }, register("purchase_id")))),
                                                                errors.purchase_id && react_1["default"].createElement("p", { className: "text-danger" }, errors.purchase_id.message))),
                                                        ...
                                                        react_1["default"].createElement("div", { className: "col-lg-2" },
                                                            react_1["default"].createElement("div", { className: "input-box" },
                                                                ...
                                                                react_1["default"].createElement("div", { className: "form-group" },
                                                                    ...
                                                                    react_1["default"].createElement("input", __assign({ className: "form-control", type: "date" }, register("purchase_date")))),
                                                                errors.purchase_date && react_1["default"].createElement("p", { className: "text-danger" }, errors.purchase_date.message))),
                                                        react_1["default"].createElement("div", { className: "col-lg-4" },
                                                            react_1["default"].createElement("div", { className: "input-box" },
                                                                react_1["default"].createElement("label", { className: "label-text" }, "Purcahse Note"),
                                                                react_1["default"].createElement("div", { className: "form-group" },
                                                                    react_1["default"].createElement("span", { className: "la la-user form-icon" }),
                                                    ...
                                                    react_1["default"].createElement("div", { className: "row" },
                                                        react_1["default"].createElement("div", { className: "col-lg-12" },
                                                            react_1["default"].createElement("div", { className: "btn-box" },
                                                                react_1["default"].createElement(Button_1["default"], { type: "submit", className: "btn btn-primary", label: "add Purchase" }))))))))))),
