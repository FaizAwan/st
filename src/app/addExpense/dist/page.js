...
var AddExpense = function () {
    ...
    var submitForm = function (_a) {
        var name = _a.name, urdu_name = _a.urdu_name, status = _a.status;
        return __awaiter(void 0, void 0, void 0, function () {
            var db, ExpenseIdRef, accountIdRef, ExpenseSnapshot, nextExpenseId, accountSnapshot, nextAccountId, ExpenseData, ExpensesRef, accountsData, accountsRef, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(name && urdu_name && status)) return [3 /*break*/, 9];
                        db = database_1.getDatabase();
                        ExpenseIdRef = database_1.ref(db, 'Expense_id_counter');
                        accountIdRef = database_1.ref(db, 'account_id_counter');
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 8, , 9]);
                        return [4 /*yield*/, database_1.get(ExpenseIdRef)];
                    case 2:
                        ExpenseSnapshot = _b.sent();
                        nextExpenseId = (ExpenseSnapshot.val() || 0) + 1;
                    ...
                    case 3:
                        ...
                        ExpensesRef = database_1.ref(db, 'Expenses/' + nextExpenseId);
                        return [4 /*yield*/, database_1.set(ExpensesRef, ExpenseData)];
                    case 4:
                        _b.sent();
                        accountsData = {
                    ...
                    case 5:
                        _b.sent();
                        // Update the Expense ID counter
                        return [4 /*yield*/, database_1.set(ExpenseIdRef, nextExpenseId)];
                    case 6:
                        // Update the Expense ID counter
                        _b.sent();
                    ...
                    case 7:
                        // Update the account ID counter
                        _b.sent();
                        alert("Expense information saved");
                        setVisibility("");
                        router.push('/expenses'); // Redirect to the Expenses page
                        return [3 /*break*/, 9];
                    case 8:
                        e_1 = _b.sent();
                        alert("Failed to save Expense information " + e_1.message);
                        return [3 /*break*/, 9];
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "Add Expense")))),
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-list text-right" },
                                    React.createElement("ul", { className: "list-items" },
                                        ...
                                        React.createElement("li", null, "Expenses"))))))),
                                ...
                                React.createElement("div", { className: "row" },
                                    React.createElement("div", { className: "col-lg-9 mx-auto" },
                                        React.createElement("div", { className: "listing-header pb-4" },
                                            React.createElement("h3", { className: "title font-size-28 pb-2" }, "Add Expense Form")),
                                                    ...
                                                    React.createElement("div", { className: "row" },
                                                        ...
                                                        React.createElement("div", { className: "col-lg-12" },
                                                            React.createElement("div", { className: "btn-box" },
                                                                React.createElement(Button_1["default"], { type: "submit", className: "btn btn-primary", label: "Add Expense" }))))))))))),
