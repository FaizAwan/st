...
const AddExpense = () => {
  ...
  const submitForm = async ({ name, urdu_name, status }: {
    name?: string | null,
    urdu_name?: string | null,
    status?:string | null }) => {
    if (name  && urdu_name && status) {
      const db = getDatabase();
      const ExpenseIdRef = ref(db, 'Expense_id_counter');
      const accountIdRef = ref(db, 'account_id_counter');
      try {
        // Get the next Expense ID
        const ExpenseSnapshot = await get(ExpenseIdRef);
        const nextExpenseId = (ExpenseSnapshot.val() || 0) + 1; // Increment Expense ID
        ...
        // Write to the Expenses table
        const ExpensesRef = ref(db, 'Expenses/' + nextExpenseId);
        await set(ExpensesRef, ExpenseData);
        
        // Write to the accounts table (only account_id, Expense_id, type)
        const accountsData = {
        ...
        await set(ExpenseIdRef, nextExpenseId);
        ...
        alert("Failed to save Expense information " + e.message);
      }
    }
  };
                      ...
                      <div className="dropdown-menu dropdown-reveal dropdown-menu-md dropdown-menu-right">
                        ...
                        <div className="list-group drop-reveal-list user-drop-reveal-list">
                          ...
                          <a href="admin-dashboard-orders.html" className="list-group-item list-group-item-action">
                            <div className="msg-body">
                              <div className="msg-content">
                                <h3 className="title"><i className="la la-shopping-cart mr-2" />Expenses</h3>
                              </div>
                            </div>{/* end msg-body */}
                          </a>
                          <a href="#" className="list-group-item list-group-item-action">
            ...
            <div className="col-lg-6">
              <div className="breadcrumb-content">
                <div className="section-heading">
                  <h2 className="sec__title font-size-30 text-white">Add Expense</h2>
                </div>
      ...
      <div className="row">
        <div className="col-lg-9 mx-auto">
          <div className="listing-header pb-4">
            <h3 className="title font-size-28 pb-2">Add Expense Form</h3>
          </div>
          <div className="form-box">
            <div className="form-title-wrap">
              <h3 className="title"><i className="la la-user mr-2 text-gray" />Expense information</h3>
            </div>{/* form-title-wrap */}
                              ...
                              <div className="row">
                                ...
                                <div className="col-lg-12">
                                  <div className="btn-box">
                                    <SubmitButton type="submit" className="btn btn-primary" label="Add Expense" />
                                  </div>
                                </div>
                              </div>{/* end row */}
                            </form>
