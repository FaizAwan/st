...
var AddReturnPurchase = function () {
    ...
    var submitForm = function (_a) {
        var ReturnPurchases_date = _a.ReturnPurchases_date, ReturnPurchases_id = _a.ReturnPurchases_id, customer_name = _a.customer_name, note = _a.note, total_amount = _a.total_amount;
        return __awaiter(void 0, void 0, void 0, function () {
            var db_1, ReturnPurchasesIdRef, ReturnPurchasesnapshot, nextReturnPurchasesId_1, ReturnPurchasesData, ReturnPurchasesRef, ReturnPurchasesProductRef, productPromises, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        console.log("Form data received:", {
                            ReturnPurchases_date: ReturnPurchases_date,
                            ReturnPurchases_id: ReturnPurchases_id,
                            customer_name: customer_name,
                            note: note,
                            total_amount: total_amount
                        });
                        if (!(ReturnPurchases_date && ReturnPurchases_id && customer_name && note && total_amount)) return [3 /*break*/, 8];
                        db_1 = database_1.getDatabase();
                        ReturnPurchasesIdRef = database_1.ref(db_1, 'ReturnPurchases_id_counter');
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 6, , 7]);
                        console.log("Fetching the next ReturnPurchases ID...");
                        return [4 /*yield*/, database_1.get(ReturnPurchasesIdRef)];
                    case 2:
                        ReturnPurchasesnapshot = _b.sent();
                        nextReturnPurchasesId_1 = (ReturnPurchasesnapshot.val() || 0) + 1;
                        console.log("Next ReturnPurchases ID:", nextReturnPurchasesId_1);
                        ReturnPurchasesData = {
                            ReturnPurchases_id: nextReturnPurchasesId_1,
                            ReturnPurchases_date: ReturnPurchases_date,
                            customer_name: customer_name,
                            note: note,
                        ...
                        ReturnPurchasesRef = database_1.ref(db_1, 'ReturnPurchases/' + nextReturnPurchasesId_1);
                        return [4 /*yield*/, database_1.set(ReturnPurchasesRef, ReturnPurchasesData)];
                    case 3:
                        _b.sent();
                        // console.log("ReturnPurchases data saved successfully.");
                        // Update the ReturnPurchases ID counter
                        return [4 /*yield*/, database_1.set(ReturnPurchasesIdRef, nextReturnPurchasesId_1)];
                    case 4:
                        // console.log("ReturnPurchases data saved successfully.");
                        // Update the ReturnPurchases ID counter
                        _b.sent();
                        ReturnPurchasesProductRef = database_1.ref(db_1, 'ReturnPurchasesProduct');
                        productPromises = productTableData.map(function (product, index) {
                            ...
                            var productKey = nextReturnPurchasesId_1 + "_" + (index + 1);
                            return database_1.set(database_1.ref(db_1, "ReturnPurchasesProduct/" + productKey), productEntry);
                        });
                    ...
                    case 6:
                        e_1 = _b.sent();
                        console.error("Error saving ReturnPurchases information:", e_1);
                        alert("Failed to save ReturnPurchases information " + e_1.message);
                        return [3 /*break*/, 7];
                            ...
                            react_1["default"].createElement("div", { className: "col-lg-6" },
                                react_1["default"].createElement("div", { className: "breadcrumb-content" },
                                    react_1["default"].createElement("div", { className: "section-heading" },
                                        react_1["default"].createElement("h2", { className: "sec__title font-size-30 text-white" }, "Add Return Purchase")))),
                            react_1["default"].createElement("div", { className: "col-lg-6" },
                                react_1["default"].createElement("div", { className: "breadcrumb-list text-right" },
                                    react_1["default"].createElement("ul", { className: "list-items" },
                                        ...
                                        react_1["default"].createElement("li", null, "Add Return Purchase"))))))),
                                                    ...
                                                    react_1["default"].createElement("div", { className: "row" },
                                                        react_1["default"].createElement("div", { className: "col-lg-1" },
                                                            react_1["default"].createElement("div", { className: "input-box" },
                                                                react_1["default"].createElement("label", { className: "label-text" }, "Purchase ID"),
                                                                react_1["default"].createElement("div", { className: "form-group" },
                                                                    react_1["default"].createElement("span", { className: "la la-list form-icon" }),
                                                                    react_1["default"].createElement("input", __assign({ className: "form-control", value: "981", type: "text" }, register("ReturnPurchases_id")))),
                                                                errors.ReturnPurchases_id && react_1["default"].createElement("p", { className: "text-danger" }, errors.ReturnPurchases_id.message))),
                                                        react_1["default"].createElement("div", { className: "col-lg-3" },
                                                            react_1["default"].createElement("div", { className: "input-box" },
                                                                react_1["default"].createElement("label", { className: "label-text" }, "Supplier Name"),
                                                                react_1["default"].createElement("div", { className: "form-group" },
                                                                    ...
                                                                    react_1["default"].createElement("select", __assign({ name: "customer_name" }, register('customer_name'), { className: "form-control" }),
                                                                        react_1["default"].createElement("option", { value: "" }, "---Select Supplier---"),
                                                        ...
                                                        react_1["default"].createElement("div", { className: "col-lg-2" },
                                                            react_1["default"].createElement("div", { className: "input-box" },
                                                                ...
                                                                react_1["default"].createElement("div", { className: "form-group" },
                                                                    ...
                                                                    react_1["default"].createElement("input", __assign({ className: "form-control", type: "date" }, register("ReturnPurchases_date")))),
                                                                errors.ReturnPurchases_date && react_1["default"].createElement("p", { className: "text-danger" }, errors.ReturnPurchases_date.message))),
                                                        react_1["default"].createElement("div", { className: "col-lg-4" },
                                                            react_1["default"].createElement("div", { className: "input-box" },
                                                                react_1["default"].createElement("label", { className: "label-text" }, "Return Purchase Note"),
                                                                react_1["default"].createElement("div", { className: "form-group" },
                                                                    react_1["default"].createElement("span", { className: "la la-user form-icon" }),
...
exports["default"] = AddReturnPurchase;
