...
var Vouchers = function () {
    ...
    var _b = react_1.useState([]), Vouchers = _b[0], setVouchers = _b[1];
    ...
    react_1.useEffect(function () {
        ...
        var VouchersRef = database_1.ref(db, 'Vouchers/');
        database_1.onValue(VouchersRef, function (snapshot) {
            var data = snapshot.val();
            var VouchersList = Object.keys(data).map(function (key) { return (__assign({ id: key }, data[key])); });
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "Vouchers")))),
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-list text-right" },
                                    React.createElement("ul", { className: "list-items" },
                                        React.createElement("li", null,
                                            React.createElement(link_1["default"], { href: "vouchers/customers", className: "text-white" }, "Vouchers")),
                                        React.createElement("li", null,
                                            React.createElement(link_1["default"], { href: "vouchers/suppliers", className: "text-white" }, "Suppliers")),
                                        React.createElement("li", null,
                                            React.createElement(link_1["default"], { href: "vouchers/banks", className: "text-white" }, "Banks")),
                                        React.createElement("li", null,
                                            React.createElement(link_1["default"], { href: "vouchers/expenses", className: "text-white" }, "Expenses")))))))),
                                    ...
                                    React.createElement("div", { className: "form-title-wrap" },
                                        React.createElement("div", { className: "d-flex align-items-center justify-content-between" },
                                            React.createElement("div", null,
                                                React.createElement("h3", { className: "title" }, "Voucher Lists"),
                                            ...
                                            React.createElement("div", { className: "select-contain" },
                                                React.createElement(link_1["default"], { href: "addVoucher", className: "btn btn-primary" }, " Add Voucher ")))),
                                            ...
                                            React.createElement("table", { className: "table" },
                                                React.createElement("thead", null,
                                                    React.createElement("tr", null,
                                                        React.createElement("th", { scope: "col" }, "Voucher Name"),
                                                        React.createElement("th", { scope: "col" }, "Urdu Name"),
                                                        React.createElement("th", { scope: "col" }, "Whatsapp"),
                                                ...
                                                React.createElement("tbody", null, Vouchers.map(function (Voucher) { return (React.createElement("tr", { key: Voucher.id },
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, Voucher.name))),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, Voucher.urdu_name))),
                                                    React.createElement("td", null, Voucher.whatsapp),
                                                    React.createElement("td", null, Voucher.city),
                                                    React.createElement("td", null, Voucher.address),
                                                    React.createElement("td", null),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
