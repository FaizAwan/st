...
const Vouchers = () => {
    ...
    useEffect(() => {
      ...
      onValue(VouchersRef, (snapshot) => {
        ...
        const VouchersList = Object.keys(data).map(key => ({
          id: key,
          ...data[key]
        }));
            ...
            <div className="col-lg-6">
              <div className="breadcrumb-content">
                <div className="section-heading">
                  <h2 className="sec__title font-size-30 text-white">Vouchers</h2>
                </div>
            ...
            <div className="col-lg-6">
              <div className="breadcrumb-list text-right">
                <ul className="list-items">
                  <li><Link href="vouchers/customers" className="text-white">Vouchers</Link></li>
                  <li><Link href="vouchers/suppliers" className="text-white">Suppliers</Link></li>
                  <li><Link href="vouchers/banks" className="text-white">Banks</Link></li>
                  <li><Link href="vouchers/expenses" className="text-white">Expenses</Link></li>
                </ul>
            ...
            <div className="col-lg-12">
              <div className="form-box">
                <div className="form-title-wrap">
                  <div className="d-flex align-items-center justify-content-between">
                    <div>
                      <h3 className="title">Voucher Lists</h3>
                      <p className="font-size-14">Showing 1 to 8 of 20 results</p>
                    </div>
                    <div className="select-contain">
                      <Link href="addVoucher" className="btn btn-primary"> Add Voucher </Link>
                    </div>
                  </div>
                </div>
                          ...
                          <tr key={Voucher.id}>
                            <td>
                              <div className="table-content">
                                <h3 className="title">{Voucher.name}</h3>
                              </div>
                            </td>
                            <td>
                              <div className="table-content">
                                <h3 className="title">{Voucher.urdu_name}</h3>
                              </div>
                            </td>
                            <td>{Voucher.whatsapp}</td>
                            <td>{Voucher.city}</td>
                            <td>{Voucher.address}</td>
                            <td>{/* Total Bills Value */}</td>
                            <td>
                              <div className="table-content">
