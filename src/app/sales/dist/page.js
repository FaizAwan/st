...
var Sales = function () {
    ...
    var _b = react_1.useState([]), Sales = _b[0], setSales = _b[1];
    ...
    react_1.useEffect(function () {
        ...
        var SalesRef = database_1.ref(db, 'Sales/');
        database_1.onValue(SalesRef, function (snapshot) {
            var data = snapshot.val();
            var SalesList = Object.keys(data).map(function (key) { return (__assign({ id: key }, data[key])); });
            setSales(SalesList);
        });
    }, []);
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "Sales")))),
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-list text-right" },
                                    React.createElement("ul", { className: "list-items" },
                                        React.createElement("li", null,
                                            React.createElement(link_1["default"], { href: "Sales", className: "text-white" }, "Sales")),
                                        React.createElement("li", null,
                                            React.createElement(link_1["default"], { href: "suppliers", className: "text-white" }, "Suppliers")),
                                        React.createElement("li", null,
                                            React.createElement(link_1["default"], { href: "banks", className: "text-white" }, "Banks")),
                                        React.createElement("li", null,
                                            React.createElement(link_1["default"], { href: "expenses", className: "text-white" }, "Expenses")))))))),
                                    ...
                                    React.createElement("div", { className: "form-title-wrap" },
                                        React.createElement("div", { className: "d-flex align-items-center justify-content-between" },
                                            React.createElement("div", null,
                                                React.createElement("h3", { className: "title" }, "Sale Lists"),
                                            ...
                                            React.createElement("div", { className: "select-contain" },
                                                React.createElement(link_1["default"], { href: "addSale", className: "btn btn-primary" }, " Add Sale ")))),
                                            ...
                                            React.createElement("table", { className: "table" },
                                                React.createElement("thead", null,
                                                    React.createElement("tr", null,
                                                        React.createElement("th", { scope: "col" }, "Sale ID"),
                                                        React.createElement("th", { scope: "col" }, "Customer Name"),
                                                        React.createElement("th", { scope: "col" }, "Note"),
                                                        React.createElement("th", { scope: "col" }, "Sale Type"),
                                                        React.createElement("th", { scope: "col" }, "Total Amount"),
                                                        React.createElement("th", { scope: "col" }, "Status"),
                                                        React.createElement("th", { scope: "col" }, "Action"))),
                                                React.createElement("tbody", null, Sales.map(function (Sale) { return (React.createElement("tr", { key: Sale.id },
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, Sale.id))),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, Sale.customer_name))),
                                                    React.createElement("td", null, Sale.note),
                                                    React.createElement("td", null, Sale.sale_type),
