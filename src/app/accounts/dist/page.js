...
var Accounts = function () {
    ...
    var _b = react_1.useState([]), accounts = _b[0], setaccounts = _b[1];
    ...
    react_1.useEffect(function () {
        ...
        var accountsRef = database_1.ref(db, 'accounts/');
        database_1.onValue(accountsRef, function (snapshot) {
            var data = snapshot.val();
            var accountsList = Object.keys(data).map(function (key) { return (__assign({ id: key }, data[key])); });
                                                ...
                                                React.createElement("div", { className: "dropdown-menu dropdown-reveal dropdown-menu-xl dropdown-menu-right" },
                                                    ...
                                                    React.createElement("div", { className: "list-group drop-reveal-list" },
                                                        ...
                                                        React.createElement("a", { href: "#", className: "list-group-item list-group-item-action" },
                                                            React.createElement("div", { className: "msg-body d-flex align-items-center" },
                                                                React.createElement("div", { className: "avatar flex-shrink-0 mr-3" },
                                                                    React.createElement(image_1["default"], { alt: "tagLine", src: "template/images/team9.jpg", ayout: "fill", objectFit: "cover" })),
                                                                React.createElement("div", { className: "msg-content w-100" },
                                                                    React.createElement("div", { className: "d-flex align-items-center justify-content-between" },
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "accounts")))),
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-list text-right" },
                                    React.createElement("ul", { className: "list-items" },
                                        ...
                                        React.createElement("li", null, "accounts"))))))),
                                    ...
                                    React.createElement("div", { className: "form-title-wrap" },
                                        React.createElement("div", { className: "d-flex align-items-center justify-content-between" },
                                            React.createElement("div", null,
                                                React.createElement("h3", { className: "title" }, "account Lists"),
                                            ...
                                            React.createElement("table", { className: "table" },
                                                React.createElement("thead", null,
                                                    React.createElement("tr", null,
                                                        React.createElement("th", { scope: "col" }, "Account ID"),
                                                ...
                                                React.createElement("tbody", null, accounts.map(function (account) { return (React.createElement("tr", { key: account.id },
                                                    React.createElement("td", null, account.id),
                                                    React.createElement("td", null, account.type),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("h3", { className: "title" }, account.name))),
                                                    React.createElement("td", null, account.whatsapp),
                                                    React.createElement("td", null, account.address),
                                                    React.createElement("td", null, account.city),
                                                    React.createElement("td", null, "Active"),
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "table-content" },
                                                            React.createElement("a", { href: "admin-dashboard-orders-details.html", className: "theme-btn theme-btn-small mr-2", "data-toggle": "tooltip", "data-placement": "top", title: "View details" },
