...
var AddBank = function () {
    ...
    var submitForm = function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var db, BankIdRef, accountIdRef, BankSnapshot, nextBankId, accountSnapshot, nextAccountId, BankData, BanksRef, accountsData, accountsRef, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(name && city && whatsapp && address && urdu_name && status)) return [3 /*break*/, 9];
                        db = database_1.getDatabase();
                        BankIdRef = database_1.ref(db, 'Bank_id_counter');
                        accountIdRef = database_1.ref(db, 'account_id_counter');
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 8, , 9]);
                        return [4 /*yield*/, database_1.get(BankIdRef)];
                    case 2:
                        BankSnapshot = _b.sent();
                        nextBankId = (BankSnapshot.val() || 0) + 1;
                    ...
                    case 3:
                        ...
                        BanksRef = database_1.ref(db, 'Banks/' + nextBankId);
                        return [4 /*yield*/, database_1.set(BanksRef, BankData)];
                    case 4:
                        _b.sent();
                        accountsData = {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, database_1.set(BankIdRef, nextBankId)];
                    case 6:
                        // Update the Bank ID counter
                        _b.sent();
                    ...
                    case 8:
                        e_1 = _b.sent();
                        alert("Failed to save Bank information " + e_1.message);
                        return [3 /*break*/, 9];
                            ...
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-content" },
                                    React.createElement("div", { className: "section-heading" },
                                        React.createElement("h2", { className: "sec__title font-size-30 text-white" }, "Add Bank")))),
                            React.createElement("div", { className: "col-lg-6" },
                                React.createElement("div", { className: "breadcrumb-list text-right" },
                                    React.createElement("ul", { className: "list-items" },
                                        ...
                                        React.createElement("li", null, "Banks"))))))),
                                ...
                                React.createElement("div", { className: "row" },
                                    React.createElement("div", { className: "col-lg-9 mx-auto" },
                                        React.createElement("div", { className: "listing-header pb-4" },
                                            React.createElement("h3", { className: "title font-size-28 pb-2" }, "Add Bank Form")),
                                                    ...
                                                    React.createElement("div", { className: "row" },
                                                        ...
                                                        React.createElement("div", { className: "col-lg-12" },
                                                            React.createElement("div", { className: "btn-box" },
                                                                React.createElement(Button_1["default"], { type: "submit", className: "btn btn-primary", label: "Add Bank" }))))))))))),
